...
# Change the server_names_hash_bucket_size line to 128
RUN sed -i 's/server_names_hash_bucket_size [0-9]\+/server_names_hash_bucket_size 128/g' /etc/nginx/nginx.conf
